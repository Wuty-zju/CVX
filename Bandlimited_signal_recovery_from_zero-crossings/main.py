...
y_recovered = optimization_solve(n, f_min, B, s, y)
...
# 输出结果，绘制原始信号y和估计信号y_recovered的图像
plot_and_save_with_csv(y, 'zero_crossings_data', 'time', 'bandlimited signals', results_output_folder_path, fig_size=(24, 5), y2_data=y_recovered, y2_label='bandlimited signals', legend1='original', legend2='recovered')
